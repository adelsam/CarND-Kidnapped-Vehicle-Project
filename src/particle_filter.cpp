...
//  cout << "dataAssociation called with predicted: " << predicted.size() << " and observations: " << observations.size()
//       << endl;
  // n^2 nearest neighbor search, do we allow two measurements to hit the same map landmark?
...
//      cout << "matched observation (" << observation.x << ", " << observation.y << ")" << " to " << " landmark "
//           << closest_landmark.id << " (" << closest_landmark.x << ", " << closest_landmark.y << ") dist = "
//           << closest_distance << endl;
//    } else {
//      cout << "no landmark for observation (" << observation.x << ", " << observation.y << ")" << endl;
    }
  }
